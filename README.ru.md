...
Это программное обеспечение предназначено для обхода систем глубокой проверки пакетов, которые встречаются у многих интернет-провайдеров и блокируют доступ к определённым сайтам.
...
Активное DPI более сложно обмануть. В настоящее время программное обеспечение использует 7 методов для обхода активного DPI:
